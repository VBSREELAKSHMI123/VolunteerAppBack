...
// API to verify a volunteer (set `verified` to true)
...
// Get a specific volunteer's details (including availability status)
...
// API to verify a request and notify the user dashboard
...
// API to get requests for a specific user
